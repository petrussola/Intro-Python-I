...
def get_user_choice(user, computer):
    previous_round_choices(user, computer)
...
def display_result_message_and_update_score(result, computer_choice):
...
def previous_round_choices(user, computer):
    print(f"Computer chose {user} last time")
    print(f"You chose {computer} last time")
...
while user_choice != "quit":
    ...
    display_result_message_and_update_score(result, computer_choice)
